...
# -*- coding: utf-8 -*-
"""
Created on Sat May 30 01:40:56 2020

@author: naveen_p
Reference Repository : "https://github.com/AceCoooool/LEDNet/blob/master/model/basic.py"
"""
...
class LEDNet(nn.Module):
    def __init__(self, nclass=3, drop=0.1):
        super(LEDNet, self).__init__()
        self.encoder = nn.Sequential(
            DownSampling(1, 31), SSnbt(32, 1, 0.1 * drop), SSnbt(32, 1, 0.1 * drop), SSnbt(32, 1, 0.1 * drop),
