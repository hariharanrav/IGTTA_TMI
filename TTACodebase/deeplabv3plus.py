...
class ResNet(nn.Module):
    def __init__(self, in_channels=1, output_stride=16, backbone='resnet101', pretrained=False):
...
class Xception(nn.Module):
    def __init__(self, output_stride=16, in_channels=1, pretrained=False):
...
class DeepLabV3plus(BaseModel):
    def __init__(self, num_classes=3, in_channels=1, backbone='xception', pretrained=False, 
